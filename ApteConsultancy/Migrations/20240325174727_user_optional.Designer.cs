...
namespace ApteConsultancy.Migrations
{
    ...
    [Migration("20240325174727_user_optional")]
    partial class user_optional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArchitectProject", b =>
                {
                    b.Property<int>("ArchitectsArchitectId")
                        .HasColumnType("int");

                    b.Property<int>("ProjectsProjectId")
                        .HasColumnType("int");

                    b.HasKey("ArchitectsArchitectId", "ProjectsProjectId");

                    b.HasIndex("ProjectsProjectId");

                    b.ToTable("ArchitectProject");
                });
            ...
            modelBuilder.Entity("ArchitectProject", b =>
                {
                    b.HasOne("ApteConsultancy.Models.Master.Architect", null)
                        .WithMany()
                        .HasForeignKey("ArchitectsArchitectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
